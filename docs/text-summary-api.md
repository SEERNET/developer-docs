...
| ---------- | ------ | -------------------------------------------------------------- | ------------------------------------------------------------------- |
| request_id | String | The request id.                                                | This defaults to the originally sent id or is generated by the api. |
| response   | Object | key `extractive`, value: List of summary score object. |                                                                     |
...
| Parameter  | Type   | Description                                | Notes |
| ---------- | ------ | ------------------------------------------ | ----- |
| long       | Object | List of Summary-Score Segment. | the long abstractive summary      |
| short       | Object | List of Summary-Score Segment. |     |
...
| score      | Float  | confidence score for the summary line            |       |

> **NOTE:** 
> In case of extractive, the start and end times refer to the exact time of the segment.
